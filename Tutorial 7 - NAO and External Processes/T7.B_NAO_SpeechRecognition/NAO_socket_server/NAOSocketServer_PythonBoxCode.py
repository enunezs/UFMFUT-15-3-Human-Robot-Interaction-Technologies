#----------------------------------------------------------------------------------#
# By Emanuel Nunez and Edward White updated by Paul Bremner
# Version 1.2s
#----------------------------------------------------------------------------------#
# Notes
...
host = '169.254.131.17'     # = 'FIND YOUR IP ADDRESS' # See above notes
...
class MyClass(GeneratedClass):
    ...
    def onInput_onStart(self):
        ...
        ### 2. Send a message          
        client_socket.sendall("1".encode()) #Sends a 1 to the server, this triggers speech recognition
